...
class Player:
    ...
    def debate(self, other):
        "*** YOUR CODE HERE ***"
        self.popularity = self.popularity + 50 if random() < max(0.1 ,self.popularity/(self.popularity + other.popularity))  else max(0, self.popularity - 50)
...
class VirFib():
    ...
    def next(self):
        ...
        if self.value == 0:
            ...
            next_one = VirFib(self.value + self.previous)
